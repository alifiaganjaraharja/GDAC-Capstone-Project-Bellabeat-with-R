...
2. Data Cleaning (Changing data types, merging two datasets, checking and removing duplicates, and checking for missing values)
3. Analysis (Finding summary statistics and correlation coefficient between two variables)
4. Data Visualization (Creating scatterplots, bar charts, box plots, etc)
